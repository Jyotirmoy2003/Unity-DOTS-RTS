...
partial struct RandomWalkingSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        in SystemAPI.Query<RefRW<RandomWalking>,RefRW<UnitMover>,RefRO<LocalTransform>>())
        {
            ...
            if(math.distancesq(localTransform.ValueRO.Position,randomWalking.ValueRO.targetPoisition) < UnitMoverSystem.REACHED_TARGET_POSITION_DISTANCESQ)
            {
                //Reached the target
                ...
                randomWalking.ValueRW.targetPoisition = randomWalking.ValueRO.originPosition +
            ...
            {
                //Too far, move closer
                unitMover.ValueRW.targetPosition = randomWalking.ValueRO.targetPoisition;
            }
        }
