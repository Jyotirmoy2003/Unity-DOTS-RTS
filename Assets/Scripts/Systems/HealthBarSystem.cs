...
partial struct HealthBarSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach((RefRW<LocalTransform> localTransform,RefRO<HealthBar> healthBar) in SystemAPI.Query<RefRW<LocalTransform>,RefRO<HealthBar>>())
        {
            ...
            if(localTransform.ValueRO.Scale ==1f) //Health bar visible
            ...
            {
                continue; //health did not changed 
            }
            ...
            RefRW<PostTransformMatrix> barVisualPostTranformMatrix = SystemAPI.GetComponentRW<PostTransformMatrix>(healthBar.ValueRO.barVisualEntity);
